 ...
 * @data: a pointer to the struct of the program's data
 * Return: Nothing but sets errno appropriately
 */
...
/**
 * expand_alias - expands any aliases in the input of the program
